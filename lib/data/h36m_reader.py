import numpy as np
import random
from lib.utils.data import read_pkl, split_clips

random.seed(0)

# Refer MotionBERT (https://github.com/Walter0807/MotionBERT/blob/main/lib/data/datareader_h36m.py)
class H36mReader(object):
